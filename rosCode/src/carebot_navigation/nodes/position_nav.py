...
class PositionNav():  
    def __init__(self):  
        ...
        locations = dict()  
        locations['one'] = Pose(Point(0.484, -1.419, 0.000), Quaternion(0.000, 0.000, -0.748, 0.663))  
        locations['two'] = Pose(Point(-0.136, -1.469, 0.000), Quaternion(0.000, 0.000, 0.393, 0.919))  
        locations['three'] = Pose(Point(0.751, -0.375, 0.000), Quaternion(0.000, 0.000, -0.719, 0.694))  
        locations['four'] = Pose(Point(0.480, -1.00, 0.000), Quaternion(0.000, 0.000, -0.463, 0.886))  
