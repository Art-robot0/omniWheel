...
(defsystem "ros_arduino_msgs-srv"
  ...
  :components ((:file "_package")
    (:file "AlarmWrite" :depends-on ("_package_AlarmWrite"))
    (:file "_package_AlarmWrite" :depends-on ("_package"))
    ...
    (:file "LightShow" :depends-on ("_package_LightShow"))
    (:file "_package_LightShow" :depends-on ("_package"))
