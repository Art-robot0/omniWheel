...
(cl:in-package carebot_msgs-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <TakePanorama-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TakePanorama-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name carebot_msgs-srv:<TakePanorama-request> is deprecated: use carebot_msgs-srv:TakePanorama-request instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <TakePanorama-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carebot_msgs-srv:mode-val is deprecated.  Use carebot_msgs-srv:mode instead.")
  (mode m))

(cl:ensure-generic-function 'pano_angle-val :lambda-list '(m))
(cl:defmethod pano_angle-val ((m <TakePanorama-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carebot_msgs-srv:pano_angle-val is deprecated.  Use carebot_msgs-srv:pano_angle instead.")
  (pano_angle m))

(cl:ensure-generic-function 'snap_interval-val :lambda-list '(m))
(cl:defmethod snap_interval-val ((m <TakePanorama-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carebot_msgs-srv:snap_interval-val is deprecated.  Use carebot_msgs-srv:snap_interval instead.")
  (snap_interval m))

(cl:ensure-generic-function 'rot_vel-val :lambda-list '(m))
(cl:defmethod rot_vel-val ((m <TakePanorama-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carebot_msgs-srv:rot_vel-val is deprecated.  Use carebot_msgs-srv:rot_vel instead.")
  (rot_vel m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TakePanorama-request>)))
  ...
  "carebot_msgs/TakePanoramaRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TakePanorama-request)))
  "Returns string type for a service object of type 'TakePanorama-request"
  "carebot_msgs/TakePanoramaRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TakePanorama-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TakePanorama-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name carebot_msgs-srv:<TakePanorama-response> is deprecated: use carebot_msgs-srv:TakePanorama-response instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <TakePanorama-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carebot_msgs-srv:status-val is deprecated.  Use carebot_msgs-srv:status instead.")
  (status m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TakePanorama-response>)))
  ...
  "carebot_msgs/TakePanoramaResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TakePanorama-response)))
  "Returns string type for a service object of type 'TakePanorama-response"
  "carebot_msgs/TakePanoramaResponse")
