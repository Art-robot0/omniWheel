...
(cl:defmethod cl:initialize-instance :after ((m <SetFollowState-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFollowState-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name carebot_msgs-srv:<SetFollowState-request> is deprecated: use carebot_msgs-srv:SetFollowState-request instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <SetFollowState-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carebot_msgs-srv:state-val is deprecated.  Use carebot_msgs-srv:state instead.")
  (state m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetFollowState-request>)))
  ...
  "carebot_msgs/SetFollowStateRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetFollowState-request)))
  "Returns string type for a service object of type 'SetFollowState-request"
  "carebot_msgs/SetFollowStateRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetFollowState-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetFollowState-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name carebot_msgs-srv:<SetFollowState-response> is deprecated: use carebot_msgs-srv:SetFollowState-response instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <SetFollowState-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader carebot_msgs-srv:result-val is deprecated.  Use carebot_msgs-srv:result instead.")
  (result m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetFollowState-response>)))
  ...
  "carebot_msgs/SetFollowStateResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetFollowState-response)))
  "Returns string type for a service object of type 'SetFollowState-response"
  "carebot_msgs/SetFollowStateResponse")
