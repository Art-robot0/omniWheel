...
"""autogenerated by genpy from carebot_msgs/TakePanoramaRequest.msg. Do not edit."""
import sys
...
class TakePanoramaRequest(genpy.Message):
  ...
  _type = "carebot_msgs/TakePanoramaRequest"
...
def _get_struct_B3f():
    ...
    return _struct_B3f
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from carebot_msgs/TakePanoramaResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class TakePanoramaResponse(genpy.Message):
  ...
  _type = "carebot_msgs/TakePanoramaResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """
uint8 status
uint8 STARTED=0
...
class TakePanorama(object):
  _type          = 'carebot_msgs/TakePanorama'
